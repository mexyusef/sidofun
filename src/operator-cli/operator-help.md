...
Browsers:
  ...
  sidofun browser runtime policy get [--json]
  sidofun browser runtime policy set [--enabled|--disabled] [--allow <host-or-url>]... [--deny <host-or-url>]... [--json]
  sidofun browser runtime windows [--runtime <runtime-id>]... [--json]
  sidofun browser runtime bind <runtime-id> [--window <handle>] [--json]
  sidofun browser runtime open-tab <runtime-id> <url> [--json]
  sidofun browser runtime tile [--runtime <runtime-id>]... [--preset <2-up|3-column|2x2|main-left|main-right|newsroom-5|newsroom-6>] [--columns <n>] [--gap <n>] [--x <n> --y <n> --width <n> --height <n>] [--json]
  sidofun browser runtime close <runtime-id> [--json]
  sidofun browser page list [--runtime <runtime-id>] [--json]
  sidofun browser page open <runtime-id> <url> [--json]
  sidofun browser page info <page-id> [--json]
  sidofun browser page dom <page-id> [--json]
  sidofun browser page fill-commit <page-id> <selector> <value> [--json]
  sidofun browser page wait-ready <page-id> --selector <selector>... [--timeout-ms <n>] [--interval-ms <n>] [--stable-reads <n>] [--json]
  sidofun browser page click-text <page-id> <text> [--contains] [--within <selector>] [--top-region] [--top-max <n>] [--no-links] [--settle-after <dom|page|network>] [--settle-timeout-ms <n>] [--settle-stable-reads <n>] [--json]
  sidofun browser page check-agreement <page-id> [--selector <selector>] [--label <text>]... [--json]
  sidofun browser page settle <page-id> <dom|page|network> [--timeout-ms <n>] [--interval-ms <n>] [--stable-reads <n>] [--quiet-ms <n>] [--json]
  sidofun browser page signup-step <page-id> --email <value> --password <value> [--email-selector <selector>] [--password-selector <selector>] [--submit-text <text>] [--wait-ready-timeout-ms <n>] [--json]
  sidofun browser page complete-profile <page-id> --email <value> [--username <value>] [--full-name <value>] [--username-selector <selector>] [--full-name-selector <selector>] [--agreement-selector <selector>] [--agreement-label <text>]... [--submit-text <text>] [--wait-ready-timeout-ms <n>] [--json]
  sidofun browser page locate <page-id> <query> [--kind <field|button|link|any>] [--exact] [--form <selector>] [--root <selector>] [--limit <n>] [--json]
  sidofun browser page fill-query <page-id> <query> <value> [--exact] [--form <selector>] [--root <selector>] [--json]
  sidofun browser page click-query <page-id> <query> [--kind <field|button|link|any>] [--exact] [--form <selector>] [--root <selector>] [--json]
  sidofun browser page submit <page-id> [query] [--exact] [--form <selector>] [--root <selector>] [--json]
  sidofun browser page scroll <page-id> <up|down|top|bottom> [query] [--json]
  sidofun browser page scroll-text <page-id> <text> [--nth <n>] [--json]
  sidofun browser page send-keys <page-id> <keys> [--query <query>] [--json]
  sidofun browser page options <page-id> <query> [--exact] [--form <selector>] [--root <selector>] [--json]
  sidofun browser page select-option <page-id> <query> <text> [--exact] [--form <selector>] [--root <selector>] [--json]
  sidofun browser page uploader <page-id> <query> [--exact] [--form <selector>] [--root <selector>] [--json]
  sidofun browser page replay <page-id> --file <path> [--json]
  sidofun browser page wait-text <page-id> <text> [--timeout-ms <n>] [--interval-ms <n>] [--json]
  sidofun browser page form-workflow <page-id> --field "<query>=<value>"... [--submit] [--submit-query <query>] [--exact] [--form <selector>] [--root <selector>] [--wait-url-includes <text>] [--wait-text <text>] [--wait-selector <selector>] [--wait-no-selector <selector>] [--timeout-ms <n>] [--interval-ms <n>] [--json]
  sidofun browser page auth-login <page-id> (--email <value> | --username <value>) --password <value> [--submit-query <query>] [--skip-submit] [--exact] [--form <selector>] [--root <selector>] [--wait-url-includes <text>] [--wait-text <text>] [--wait-selector <selector>] [--wait-no-selector <selector>] [--timeout-ms <n>] [--interval-ms <n>] [--json]
  sidofun browser page auth-signup <page-id> --password <value> [--full-name <value>] [--username <value>] [--email <value>] [--confirm-password <value>] [--submit-query <query>] [--skip-submit] [--exact] [--form <selector>] [--root <selector>] [--wait-url-includes <text>] [--wait-text <text>] [--wait-selector <selector>] [--wait-no-selector <selector>] [--timeout-ms <n>] [--interval-ms <n>] [--json]
  sidofun browser page open-workflow <runtime-id> <url> --field "<query>=<value>"... [--submit] [--submit-query <query>] [--exact] [--form <selector>] [--root <selector>] [--wait-url-includes <text>] [--wait-text <text>] [--wait-selector <selector>] [--wait-no-selector <selector>] [--timeout-ms <n>] [--interval-ms <n>] [--json]
  sidofun browser page open-and-login <runtime-id> <url> (--email <value> | --username <value>) --password <value> [--submit-query <query>] [--skip-submit] [--exact] [--form <selector>] [--root <selector>] [--wait-url-includes <text>] [--wait-text <text>] [--wait-selector <selector>] [--wait-no-selector <selector>] [--timeout-ms <n>] [--interval-ms <n>] [--json]
  sidofun browser page open-and-signup <runtime-id> <url> --password <value> [--full-name <value>] [--username <value>] [--email <value>] [--confirm-password <value>] [--submit-query <query>] [--skip-submit] [--exact] [--form <selector>] [--root <selector>] [--wait-url-includes <text>] [--wait-text <text>] [--wait-selector <selector>] [--wait-no-selector <selector>] [--timeout-ms <n>] [--interval-ms <n>] [--json]
  sidofun browser page profile list [--file <path>] [--json]
  sidofun browser page profile info <profile-id> [--file <path>] [--json]
  sidofun browser page profile login <runtime-id> <profile-id> [--file <path>] [--url <url>] [--email <value>] [--username <value>] [--password <value>] [--confirm-password <value>] [--full-name <value>] [--exact] [--form <selector>] [--root <selector>] [--timeout-ms <n>] [--interval-ms <n>] [--json]
  sidofun browser page profile signup <runtime-id> <profile-id> [--file <path>] [--url <url>] [--email <value>] [--username <value>] [--password <value>] [--confirm-password <value>] [--full-name <value>] [--exact] [--form <selector>] [--root <selector>] [--timeout-ms <n>] [--interval-ms <n>] [--json]
  sidofun browser agent run <runtime-id> --file <path> [--url <url>] [--goal <text>] [--trajectory <trajectory-id>] [--json]
  sidofun browser page close <page-id> [--json]

Browser Page Workflow:
  1. Run `sidofun browser runtime list --json` to get `<runtime-id>`.
  2. To constrain where runtime-backed automation may navigate, run `sidofun browser runtime policy set --enabled --allow example.com --allow app.example.com --json`.
  3. Run `sidofun browser runtime open-tab <runtime-id> <url> --json` or `sidofun browser page open <runtime-id> <url> --json`.
  4. Run `sidofun browser page list --runtime <runtime-id> --json` to get `<page-id>`.
  5. Run `sidofun browser page locate <page-id> "Email" --kind field --json` to inspect semantic matches before acting.
  6. Use `--form <selector>` or `--root <selector>` when a page needs custom selector scoping, for example `sidofun browser page locate <page-id> "Email" --kind field --root main --json`.
  7. Run `sidofun browser page fill-query <page-id> "Email" user@example.com --json` and `sidofun browser page click-query <page-id> "Continue" --json`.
  8. To inspect stable interactive elements and fingerprints before replay or agent execution, run `sidofun browser page dom <page-id> --json`.
  9. For low-level primitives, use `sidofun browser page fill-commit <page-id> "input[name='email']" user@example.com --json`, `sidofun browser page wait-ready <page-id> --selector "input[name='email']" --selector "input[name='password']" --json`, `sidofun browser page click-text <page-id> "Continue with email" --json`, `sidofun browser page check-agreement <page-id> --label "terms of service" --json`, or `sidofun browser page settle <page-id> dom --stable-reads 2 --json`.
  10. For richer page primitives, use `sidofun browser page scroll-text <page-id> "Pricing" --json`, `sidofun browser page send-keys <page-id> "Control+L" --json`, `sidofun browser page options <page-id> "Country" --json`, `sidofun browser page select-option <page-id> "Country" "Indonesia" --json`, or `sidofun browser page uploader <page-id> "Upload resume" --json`.
  11. For repeated signup flows, use `sidofun browser page signup-step <page-id> --email user@example.com --password secret --submit-text "Next" --json`.
  12. For repeated profile completion flows, use `sidofun browser page complete-profile <page-id> --email user@example.com --submit-text "Create Account" --json`.
  13. For one-shot form automation, run `sidofun browser page form-workflow <page-id> --field "Email=user@example.com" --field "Password=secret" --submit --wait-url-includes dashboard --json`.
  14. For common auth flows, run `sidofun browser page auth-login <page-id> --email user@example.com --password secret --wait-url-includes dashboard --json`.
  15. To do open + fill + submit + wait in one command, run `sidofun browser page open-workflow <runtime-id> https://example.com/login --field "Email=user@example.com" --field "Password=secret" --submit --wait-url-includes dashboard --json`.
  16. To do open + login in one command, run `sidofun browser page open-and-login <runtime-id> https://example.com/login --email user@example.com --password secret --wait-url-includes dashboard --json`.
  17. To use built-in site profiles, run `sidofun browser page profile list --json`, then `sidofun browser page profile login <runtime-id> <profile-id> --username demo-user --password secret --json`.
  18. To extend profiles from a file, run `sidofun browser page profile list --file _legacy/workflows/browser-page-profiles.json --json`.
  19. To replay a stored browser-page workflow against the current DOM state, run `sidofun browser page replay <page-id> --file _legacy/workflows/browser-page-replay.json --json`.
  20. To execute a structured planner/navigator batch, run `sidofun browser agent run <runtime-id> --file examples/workflows/browser-agent-verify.json --json`.
  21. Run `sidofun browser page info <page-id> --json` or `sidofun browser page close <page-id> --json`.
...
Examples:
  ...
  sidofun config set OPENCLI_RS_PATH C:github-sidokerjaansidofun-v2opencli-rs
  ...
  sidofun browser runtime list --json
  sidofun browser runtime windows --json
  sidofun browser runtime bind <runtime-id> --json
  sidofun browser runtime open-tab <runtime-id> https://example.com --json
  sidofun browser runtime tile --preset 2-up --json
  sidofun browser runtime tile --preset newsroom-5 --json
  sidofun browser page list --runtime <runtime-id> --json
  ...
  sidofun hf papers read 2601.15621 --save C:hapusqwen3-tts.md
...
Notes:
  ...
  - Browserext workflows now support composite maintained form steps such as `signup-form` and `complete-profile` in addition to the older explicit `fill-selector` / `commit-selector` style.
